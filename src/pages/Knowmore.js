...
const location = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2407.8117690572926!2d78.77762072338534!3d10.994568443609428!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3baafa4d711a4f27%3A0xd98b2745d789433c!2sM.A.M.%20College%20of%20Engineering%20and%20Technology!5e1!3m2!1sen!2sin!4v1690637393705!5m2!1sen!2sin";
...
function Contact(){
  ...
  <div className="container mx-auto rounded-md px-4">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {/* Contact Form */}
      <div className="bg-transparent bg-opacity-90 backdrop-filter backdrop-blur-md p-6 rounded-md shadow-lg">
      <iframe src={ location }title='loction' className='w-full h-full m-1 rounded-md shadow-md'></iframe>
      </div>
    </div>
  </div>
</section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center sm:text-right">
            ...
            <div className="flex justify-center sm:justify-end space-x-4">
              <a href="/Nothing" className="text-gray-400 hover:text-white">
